 ...
 * @label  Infospace
 */
class Content_Adapter_Infospace extends Content_Adapter_DeepLinkingAbstract {
	/**
	 * Fetch content
	 *
	...
	public function fetchContent($keyword) {
		$this->getClient ()->setHeaders ( 'Referer', 'http://www.info.com/' )
			->setUri ( 'http://www.info.com/search' )->setParameterGet ( array (
				'qkw'    => urlencode($keyword),
				'qcat'   => 'web',
				'r_cop'  => 'search',
		));
